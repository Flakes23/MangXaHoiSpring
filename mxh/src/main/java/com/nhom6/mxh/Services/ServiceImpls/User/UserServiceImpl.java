...
import com.nhom6.mxh.Repository.User.UserRepository;
...
public class UserServiceImpl implements UserService {
    ...
    @Autowired
    public UserServiceImpl(UserRepository userRepository, PasswordEncoder passwordEncoder, SocketWeb socketWeb) {
